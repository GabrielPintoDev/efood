...
const REMOTE_URL = 'https://api-ebac.vercel.app/efood'

const FALLBACK_RESTAURANTES: Restaurante[] = [
  {
    id: 1,
...
export const fetchRestaurantes = async (): Promise<Restaurante[]> => {
  try {
    ...
    console.warn('fetchRestaurantes: remote failed, using fallback', err)
    return FALLBACK_RESTAURANTES
  }
}
